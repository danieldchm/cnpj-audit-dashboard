    ...
    historyDiv.innerHTML = `
      <div id="welcome-screen" class="welcome-screen flex flex-col items-center text-center py-lg my-auto">
        ...
        <p class="text-on-surface-variant font-body-sm max-w-[500px] mb-md leading-relaxed">
          Este painel permite interagir em tempo real com o modelo local <strong>Gemma 4 12B (MLX)</strong> usando ferramentas do protocolo MCP. Faça perguntas ou selecione um comando abaixo para auditar CNPJs.
        </p>
