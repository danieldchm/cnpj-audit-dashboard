/**
 * @file utils.js (v2)
 * @description Utilitários do AuditBase + Engine de Scoring VPA v2.
 *
 ...
 *    para o ICP da VPA (pequeno varejo), situação cadastral como GATE
...
const Utils = (function () {
  ...
  function calculateVpaScore(internalData, officialData, divergences) {
    ...
    const anglesMap = {
      ...
      armarinho:   'linha de armarinho e correlatos VPA',
      geral:       'portfólio VPA (papelaria, escritório, educacional)',
    };
    ...
    if (gateKey === 'BAIXADA' || gateKey === 'NULA') {
      ...
      priority = 'MEDIA';
      action = `SDR: WhatsApp + catálogo digital VPA. Destaque: ${angle}. ${recStr.charAt(0).toUpperCase() + recStr.slice(1)}.`;
      color = 'blue';
